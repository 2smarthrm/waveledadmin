...
const statusOptions = [
    ...
    { value: 'inprogress', label: 'In Progress', color: '#0119FF' },
...
const orderOptions = [
    { value: 'ascending', label: 'Ascending', color: '#0119FF' },
