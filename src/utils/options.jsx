...
const propsalStatusOptions = [
    ...
    { value: 'open', label: 'Open', color: "#0119FF" },
...
const customerListTagsOptions = [
    ...
    { value: 'team', label: 'Team', color: '#0119FF' },
    ...
    { value: 'wholesale', label: 'Wholesale', color: '#0119FF' },
...
const leadsGroupsOptions = [
    ...
    { value: "group-c", label: "Group-C", color: "#0119FF" },
    ...
    { value: "group-i", label: "Group-I", color: "#0119FF" },
    { value: "group-j", label: "Group-J", color: "#ea4d4d" },
    { value: "group-k", label: "Group-K", color: "#41b2c4" },
]

const taskStatusOptions = [
    { value: 'inprogress', label: 'Inprogress', color: '#0119FF' },
...
const taskPriorityOptions = [
    { value: 'low', label: 'Low', color: '#0119FF' },
...
const taskTypeOptions = [
    { value: 'new', label: 'New', color: '#0119FF' },
...
const projectStatusOptions = [
    { value: "in-projress", label: "In Projress", color: "#0119FF" },
...
const projectBillingOptions = [
    { value: "fixed-rate", label: "Fixed Rate", color: "#0119FF" },
...
const projectRoalOptions = [
    { value: "admin", label: "Admin", color: "#0119FF" },
